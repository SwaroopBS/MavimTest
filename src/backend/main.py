...
demo_image = face_recognition.load_image_file(r"C:\Windows\Swaroop\CAPSTONE\CAPSTONE\FRONT_END\WEB_PAGE\REACT_APP\theprofile_8_front_and_backend\src\backend\Swaroop.jpg")
...
verified_encodings = [demo_face_encodings]
verified_face_names = ["You have been verified: Swaroop"] 
